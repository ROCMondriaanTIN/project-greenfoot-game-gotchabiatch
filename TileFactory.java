    ...
    public Tile createTile(int mapIcon) {
        ...
        switch (mapIcon) {
            ...
            case 112: 
                ...
                break;
            case 113: 
                tile = new Tile("grassCliftLeftAlt.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                tile.isSolid = true;
                break;
            case 114: 
                tile = new Tile("grassCliftRight.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                tile.isSolid = true;
                break;
            case 115: 
